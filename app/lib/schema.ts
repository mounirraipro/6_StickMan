...
const SITE_URL = 'https://stickman.fr';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Stickman',
        url: SITE_URL,
        description: 'Play Stickman free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Stickman online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
