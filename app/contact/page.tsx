...
const SUPPORT_EMAIL = 'hello@stickman.fr';

export const metadata: Metadata = {
    title: 'Contact Stickman',
    description: 'Get in touch with the Stickman team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Stickman', 'Stickman support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
