...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Stickman disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Stickman disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Stickman (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on stickman.fr
                ...
                <p>
                    Stickman is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Stickman displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Stickman.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Stickman is not responsible for any errors
