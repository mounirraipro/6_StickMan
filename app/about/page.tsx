...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Stickman',
        url: 'https://stickman.fr/about',
        description: 'Learn about Stickman, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Stickman',
            url: 'https://stickman.fr',
        },
    },
    {
        '@context': 'https://schema.org',
...
export const metadata: Metadata = {
    title: 'About Us – Stickman',
    description: 'Learn about Stickman, our mission, and the team behind the game.',
    keywords: ['about Stickman', 'game team', 'who made Stickman'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Stickman</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Stickman was born from a simple idea: what if playing Stickman could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Stickman with a clear vision — to create a free, accessible, and
                    ...
                    Stickman has something for you.
                </p>
                ...
                <p>
                    Every level in Stickman is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Stickman offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Stickman better for
                    everyone.
                </p>
            </div>
        </>
