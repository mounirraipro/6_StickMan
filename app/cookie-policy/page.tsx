...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Stickman uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Stickman cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Stickman uses them, and how you can
                ...
                <p>Stickman uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Stickman.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@stickman.fr</strong>.
                </p>
            </div>
        </>
    );
