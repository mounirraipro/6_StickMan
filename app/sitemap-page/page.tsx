...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Stickman. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Stickman sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Stickman?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Stickman.</p>
                </div>
            </div>
