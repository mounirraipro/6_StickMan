...
export const metadata: Metadata = {
    ...
    description: 'Stickman is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Stickman accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Stickman accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Stickman is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Stickman presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Stickman. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@stickman.fr</strong></li>
                </ul>
                <p>
